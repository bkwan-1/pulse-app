      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-xl border border-[var(--border-default)] bg-[var(--bg-secondary)] p-6">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-primary)] px-4 py-3">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          selected
                            ...
                            : "border-[var(--border-default)] bg-[var(--bg-primary)] text-[var(--text-secondary)] hover:bg-[var(--surface)]"
                        )}
                      >
